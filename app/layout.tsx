...
export const metadata: Metadata = {
  title: 'KAHF Capital LLC - Professional Investment Proposal Tools',
  description: 'Transform your wealth management proposals with professional design tools from KAHF Capital LLC',
}
